...
' [GS] Mis declaraciones
    
    Public Const AOReadyVer As String = "0.5pub"
    Public CuentaRegresiva As Long
    
    Public CfgInvi As Byte
    Public SkillsRapidos As Boolean
    Public SeCaenLosItems As Boolean
    Public AntiAOH As Boolean
    Public Cliente0113 As Boolean
    Public Dados(1) As Byte ' 0 min 1 max
    Public Multiplicador(1) As Integer ' 0 exp, 1 oro
    Public AutoOroEquip As Boolean
    Public NOEdit As Boolean
    
    ' [GS] El soporte AO-Line SE
    ' ############ SOPORTE AO-LINE SE ############
    
    ' No el nombre del host
    Public Const DatServer As String = "AO Ready v" & AOReadyVer
    ' La web de donde la gente puede bajar el parche o demas ayuda, en el caso de no tener, no poner contenido.
    Public URL_Soporte As String
    ' Indicar 1 si usa parche, 0 si no utiliza parche (o sea si es version Alkon simple) (si es 9.9z de Alkon no significa que necesite parche)
    Public Const Parche As Boolean = False
...
Public Const MAXORO = 99999999
Public Const MAXEXP = 1999999999
...
'GS
Public Const NPCTYPE_CENTINELA = 9
Public Const NPCTYPE_CHISMOSO = 10
'/GS
...
'Estadisticas
Public STAT_MAXELV As Integer  ' [GS] lvl maximo
Public Const STAT_MAXHP = 9999  ' [GS] maximo de vida 9999
Public Const STAT_MAXSTA = 999
Public Const STAT_MAXMAN = 9000 ' [GS] maximo de mana 9000
Public Const STAT_MAXHIT = 450  ' [GS] max de hit es 450
Public Const STAT_MAXDEF = 450  ' [GS] mas de def en 450
...
Type tHechizo
    ...
    ExclusivoClase As String ' [GS] Exclusivo Clase
...
Type UserFlags
    ' GS
    Codigo As Integer
    Centinela As Byte 'Tengo Que llamar al Centinela
    PasoCentinela As Byte ' Ya paso el centinela?
    ' /GS
    ...
    Navegando As Byte
    Seguro As Boolean
    SeguroClan As Boolean ' [GS] Seguro de Clanes
