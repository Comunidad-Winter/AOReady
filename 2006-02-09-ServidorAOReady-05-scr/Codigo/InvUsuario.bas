...
Sub MakeObj(ByVal sndRoute As Byte, ByVal sndIndex As Integer, ByVal sndMap As Integer, ObjX As Obj, Map As Integer, ByVal X As Integer, ByVal Y As Integer)
        ...
        Case OBJTYPE_PERGAMINOS
            ...
            If UserList(UserIndex).flags.Hambre = 0 And _
               UserList(UserIndex).flags.Sed = 0 Then
                If LenB(Hechizos(Obj.HechizoIndex).ExclusivoClase) = 0 Or Hechizos(Obj.HechizoIndex).ExclusivoClase = UserList(UserIndex).Clase Then
